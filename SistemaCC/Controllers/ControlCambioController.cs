...
namespace SistemaCC.Controllers
{
    public class ControlCambioController : Controller
    {
        ...
        public ActionResult Ver(int id)
        {
            ...
            ViewBag.Servicios = (from sc in BD.ControlServicio join s in BD.ServiciosAplicaciones on sc.fk_SA equals s.Id_SA where sc.fk_CC == id select new { s.Nombre, sc.FechaInicio, sc.FechaFinal }).ToList();
